...
const activityFeed = [
  ...
  { user: "Ayesha S.", action: "created a Royal Greeting", time: "12m ago", icon: Sparkles, color: "text-blue-600" },
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F8FAFC] selection:bg-primary selection:text-white transition-colors duration-500 overflow-hidden">
      <Navbar />
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              ...
              >
                ...
                <div className="flex flex-wrap gap-6 pt-4">
                  <Button size="lg" className="h-16 px-10 rounded-2xl bg-primary text-white hover:bg-emerald-700 font-black text-lg shadow-xl shadow-emerald-200 group" asChild>
                  ...
                  <Button size="lg" variant="outline" className="h-16 px-10 rounded-2xl border-emerald-200 bg-white text-emerald-700 hover:bg-emerald-50 font-black text-lg shadow-sm" asChild>
                ...
                <div className="pt-8 flex items-center gap-6">
                  ...
                  <div className="text-sm font-bold text-slate-500">
                    <span className="text-slate-900 block font-black text-lg leading-tight">10,000+ Active Users</span>
                  ...
                  <div className="absolute inset-0 bg-slate-50 flex flex-col">
                    ...
                    <div className="flex-grow p-6 space-y-6">
                      <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100">
                        ...
                        <div className="aspect-square bg-slate-50 rounded-xl border border-slate-100 flex items-center justify-center overflow-hidden">
                           <Image src={PlaceHolderImages.find(img => img.id === "preview-map")?.imageUrl || ""} alt="Map" fill className="object-cover opacity-20 group-hover:scale-110 transition-transform duration-[3s]" />
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
              {stats.map((s, i) => (
                <motion.div 
                  ...
                  className="flex flex-col items-center text-center space-y-4 group p-10 rounded-[2rem] bg-white border border-slate-100 shadow-sm hover:shadow-xl transition-all"
                >
                ...
                >
                  <Link href={tool.href} className="group block h-full">
                    <Card className="h-full bg-white border border-slate-100 hover:border-emerald-200 transition-all duration-500 rounded-[2.5rem] overflow-hidden group-hover:-translate-y-2 shadow-sm hover:shadow-2xl relative">
                      <div className={cn("absolute top-0 right-0 w-32 h-32 bg-gradient-to-br opacity-5 group-hover:opacity-10 transition-opacity", tool.color)}></div>
                      <CardHeader className="p-10 pb-0">
                        <div className="flex justify-between items-start mb-10">
                          <div className={cn("w-20 h-20 rounded-2xl flex items-center justify-center bg-slate-50 transition-all duration-500 group-hover:scale-110", tool.iconColor)}>
        ...
        <section className="py-40 bg-slate-50/50">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-24 space-y-4">
              ...
              <p className="text-slate-500 max-w-lg mx-auto text-lg">Simplified digital traditions for every family.</p>
            </div>
            
            <div className="grid md:grid-cols-3 gap-12 relative">
              <div className="absolute top-1/2 left-0 w-full h-0.5 bg-gradient-to-r from-transparent via-emerald-200 to-transparent hidden md:block -translate-y-1/2"></div>
                  ...
                  <AnimatePresence initial={false}>
                    {activityFeed.map((item, i) => (
                      <motion.div 
                        ...
                        className="p-6 rounded-[2rem] bg-white border border-slate-100 flex items-center gap-5 hover:shadow-md transition-all"
                      >
                        <div className={cn("w-12 h-12 rounded-xl bg-slate-50 flex items-center justify-center shrink-0 shadow-sm", item.color)}>
              ...
              <div className="lg:col-span-8">
                <Card className="rounded-[3.5rem] overflow-hidden bg-slate-100 border-none shadow-2xl group h-[600px] relative">
                  <Image 
                    ...
                    alt="Live Map" 
                    fill 
                    className="object-cover opacity-40 group-hover:scale-105 transition-transform duration-[5s]" 
                  />
                  ...
                  <div className="absolute bottom-16 left-16 right-16 z-10 flex flex-col lg:flex-row items-center justify-between gap-10">
                    <div className="space-y-4 text-center lg:text-left">
                      ...
                      <p className="text-slate-600 max-w-sm font-medium">Join 10,000+ users checking prayer times in real-time.</p>
                    </div>
        ...
        <section className="py-40">
          <div className="max-w-5xl mx-auto px-4 text-center space-y-12">
            ...
            >
              ...
              <p className="text-xl text-emerald-700/70 max-w-xl mx-auto leading-relaxed">
                Join the most trusted Eid companion platform in Bangladesh. It's free, secure, and built for you.
              </p>
              <div className="flex flex-wrap justify-center gap-6 pt-6">
                <Button size="lg" className="h-20 px-14 rounded-[2.5rem] bg-secondary text-primary hover:bg-amber-400 font-black text-2xl shadow-2xl shadow-secondary/30 transition-all hover:scale-105 active:scale-95" asChild>
